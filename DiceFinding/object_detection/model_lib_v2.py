...
from object_detection.additional_fields import do_add_rotation_evaluator
  ...
  with summary_writer.as_default():
    with strategy.scope():
      with tf.compat.v2.summary.record_if(
        ...
        for this_step in range(global_step.value(), train_steps,
...
def eager_eval_loop(
  ...
  evaluator_options['include_y_rotation'] = do_add_rotation_evaluator(detection_model)
