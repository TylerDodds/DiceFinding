...
def result_dict_for_batched_example(images,
  ...
  if additional_fields.DetectionResultFields.y_rotation_angles in detections:
    output_dict[additional_fields.DetectionResultFields.y_rotation_angles] = detections[additional_fields.DetectionResultFields.y_rotation_angles]
...
def get_evaluators(eval_config, categories, evaluator_options=None):
  ...
  if 'include_y_rotation' in evaluator_options and evaluator_options['include_y_rotation'] is True:
      from object_detection.rotation_evaluator import RotationEvaluator
      evaluators_list.append(RotationEvaluator())
