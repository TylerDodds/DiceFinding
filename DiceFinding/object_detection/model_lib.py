...
def _prepare_groundtruth_for_eval(detection_model, class_agnostic,
  ...
  if detection_model.groundtruth_has_field(additional_fields.InputDataFields.y_rotation_angle):
    groundtruth[additional_fields.GroundtruthResultFields.y_rotation_angles] = tf.stack(detection_model.groundtruth_lists(additional_fields.InputDataFields.y_rotation_angle))
...
def provide_groundtruth(model, labels):
  ...
  if fields.InputDataFields.groundtruth_labeled_classes in labels:
    gt_labeled_classes = labels[
        fields.InputDataFields.groundtruth_labeled_classes]
  if additional_fields.InputDataFields.y_rotation_angle in labels:
    y_rot_angle_list = labels[
        additional_fields.InputDataFields.y_rotation_angle]
  model.provide_groundtruth(
      ...
      y_rotation_angles=y_rot_angle_list)
