...
def transform_input_data(tensor_dict,
  ...
  #NB We'll transform angles in the loss function, rather than here, to mirror the model's prediction heads, thus encapsulating model-specific behaviour.
...
def pad_input_data_to_static_shapes(tensor_dict,
  ...
  if additional_fields.InputDataFields.y_rotation_angle in tensor_dict:
    padding_shapes[additional_fields.InputDataFields.y_rotation_angle] = [max_num_boxes]
  if additional_fields.InputDataFields.camera_intrinsic in tensor_dict:
    padding_shapes[additional_fields.InputDataFields.camera_intrinsic] = [9]
  if additional_fields.InputDataFields.camera_distortion in tensor_dict:
    padding_shapes[additional_fields.InputDataFields.camera_distortion] = [5]
...
def _get_labels_dict(input_dict):
  ...
  optional_label_keys = [
      ...
      additional_fields.InputDataFields.camera_intrinsic,
      additional_fields.InputDataFields.camera_distortion
  ]
...
def _get_features_dict(input_dict, include_source_id=False):
  ...
  if additional_fields.InputDataFields.camera_intrinsic in input_dict:
    features[additional_fields.InputDataFields.camera_intrinsic] = input_dict[additional_fields.InputDataFields.camera_intrinsic]
  if additional_fields.InputDataFields.camera_distortion in input_dict:
    features[additional_fields.InputDataFields.camera_distortion] = input_dict[additional_fields.InputDataFields.camera_distortion]
  return features
